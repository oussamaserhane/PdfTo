...
import { FileStack, Github, Globe, Lock, Mail, ShieldCheck } from 'lucide-react';
        ...
        <div className="grid gap-12 md:grid-cols-[1.25fr_0.8fr_0.8fr_1fr]">
          <div className="space-y-5">
            <Link href={`/${locale}`} className="group inline-flex items-center gap-2.5 font-bold text-[hsl(var(--color-foreground))]">
              <span className="grid h-9 w-9 place-items-center rounded-2xl bg-gradient-to-br from-[hsl(var(--color-primary))] to-[hsl(var(--color-accent))] text-white shadow-[var(--shadow-glow)] transition-transform group-hover:scale-105">
            ...
            <div className="flex gap-3">
              <a href="https://github.com/oussamaserhane/PdfTo" target="_blank" rel="noopener noreferrer" className="grid h-10 w-10 place-items-center rounded-full bg-[hsl(var(--color-muted))] text-[hsl(var(--color-muted-foreground))] transition hover:bg-[hsl(var(--color-primary))] hover:text-white" aria-label="GitHub">
                <Github className="h-4 w-4" />
              </a>
              <a href={`mailto:${brand.supportEmail}`} className="grid h-10 w-10 place-items-center rounded-full bg-[hsl(var(--color-muted))] text-[hsl(var(--color-muted-foreground))] transition hover:bg-[hsl(var(--color-primary))] hover:text-white" aria-label="Email support">
          ...
          <div>
            <h3 className="mb-5 text-sm font-bold uppercase tracking-wider text-[hsl(var(--color-foreground))]">Privacy first</h3>
            <div className="space-y-3">
              <div className="flex items-start gap-3 rounded-2xl border border-[hsl(var(--color-border))] bg-[hsl(var(--color-card))] p-4 shadow-[var(--shadow-soft)]">
                <span className="mt-0.5 grid h-8 w-8 place-items-center rounded-xl bg-[hsl(var(--color-accent-soft))] text-[hsl(var(--color-accent))]">
                  <Lock className="h-4 w-4" />
                </span>
                <div>
                  <div className="text-sm font-semibold text-[hsl(var(--color-foreground))]">Browser-first processing</div>
                  <div className="text-xs leading-relaxed text-[hsl(var(--color-muted-foreground))]">PDFCraft tools keep sensitive files under user control.</div>
                </div>
              </div>
              <div className="flex items-start gap-3 rounded-2xl border border-[hsl(var(--color-border))] bg-[hsl(var(--color-card))] p-4 shadow-[var(--shadow-soft)]">
                <span className="mt-0.5 grid h-8 w-8 place-items-center rounded-xl bg-[hsl(var(--color-primary-soft))] text-[hsl(var(--color-primary))]">
                  <ShieldCheck className="h-4 w-4" />
                </span>
                <div>
                  <div className="text-sm font-semibold text-[hsl(var(--color-foreground))]">Self-hosting ready</div>
                  <div className="text-xs leading-relaxed text-[hsl(var(--color-muted-foreground))]">Designed to evolve toward controlled PDF automation infrastructure.</div>
                </div>
              </div>
            </div>
          </div>
